...
class journal_evaluations extends CI_Model
{
    ...
    function source($d1, $d2, $d3='')
    {
        ...
        switch($d3)
        {
            ...
            default:
            $sx .= show($dt);
            $sx .= '<a href="'.base_url(PATH.'evaluation/source/'.$d1.'/'.$d2.'/edit').'" class="btn btn-outline-primary">edit</a>';
        break;
    }
    return ($sx);
}
