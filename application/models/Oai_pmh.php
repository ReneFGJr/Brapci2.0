    ...
    function erros($erro)
    {
        ...
        function log_oai($id_jnl,$cmd,$data=array())
        {
            ...
            function process($dt) {
                ...
                return ("<h1>Index Article: " . $link . $article_id . '</a></h1><br>'.$this->frbr->msg.'');
            }
                                ...
                                if ($line = db_read($rlt)) {
                                    ...
                                    ******************************************************************************/
                                    function recupera_nr($s) {
                                        ...
                                        if (strpos($s, 'Nº ')) { $nr = substr($s, strpos($s, 'N° ') + 2, strlen($s));
                                        }
                                        if (strpos($s, 'nº')) { $nr = substr($s, strpos($s, 'nº') + 2, strlen($s));
                                        }
