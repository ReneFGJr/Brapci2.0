...
--
-- Host: localhost
-- Generation Time: Jun 17, 2019 at 06:36 PM
...
CREATE TABLE IF NOT EXISTS `patent_agent_relation` (
...
CREATE TABLE IF NOT EXISTS `patent_class` (
...
CREATE TABLE IF NOT EXISTS `patent_despacho` (
...
CREATE TABLE IF NOT EXISTS `patent_kindcode` (
...
CREATE TABLE IF NOT EXISTS `patent_pct` (
...
CREATE TABLE IF NOT EXISTS `patent_prioridade` (
...
CREATE TABLE IF NOT EXISTS `patent_pub` (
...
--
ALTER TABLE `patent`
 ADD UNIQUE KEY `id_p` (`id_p`), ADD KEY `patent_nr` (`p_nr`);

--
-- Indexes for table `patent_agent`
--
ALTER TABLE `patent_agent`
 ADD UNIQUE KEY `id_pa` (`id_pa`), ADD KEY `pa_agent` (`pa_nome`(20));

--
-- Indexes for table `patent_agent_relation`
--
ALTER TABLE `patent_agent_relation`
 ADD UNIQUE KEY `id_rl` (`id_rl`), ADD UNIQUE KEY `relacao_patent` (`rl_patent`,`rl_agent`,`rl_relation`) USING BTREE;

--
-- Indexes for table `patent_class`
--
ALTER TABLE `patent_class`
 ADD UNIQUE KEY `id_cc` (`id_cc`), ADD KEY `classes` (`cc_class`);

--
-- Indexes for table `patent_classification`
--
ALTER TABLE `patent_classification`
 ADD UNIQUE KEY `id_c` (`id_c`), ADD UNIQUE KEY `classes` (`c_patent`,`c_class`,`c_subclass`);

--
-- Indexes for table `patent_despacho`
--
ALTER TABLE `patent_despacho`
 ADD UNIQUE KEY `id_pd` (`id_pd`), ADD KEY `despache` (`pd_patent`,`pd_issue`,`pd_section`);
...
ALTER TABLE `patent_pct`
 ADD UNIQUE KEY `id_pct` (`id_pct`), ADD KEY `pct_nr` (`pct_nr`);

--
-- Indexes for table `patent_prioridade`
--
ALTER TABLE `patent_prioridade`
 ADD UNIQUE KEY `id_prior` (`id_prior`), ADD KEY `prio_numero` (`prior_numero_prioridade`(20));
