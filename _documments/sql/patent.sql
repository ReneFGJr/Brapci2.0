...
--
-- Host: localhost
-- Generation Time: Jun 14, 2019 at 08:12 PM
...
--
-- Table structure for table `patent_history`
--

CREATE TABLE IF NOT EXISTS `patent_history` (
`id_h` bigint(20) unsigned NOT NULL,
  `h_patent` int(11) NOT NULL,
  `h_section` char(10) NOT NULL,
  `h_comment` text NOT NULL,
  `h_data` date NOT NULL,
  `h_method` char(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Indexes for table `patent_history`
--
ALTER TABLE `patent_history`
...
--
-- AUTO_INCREMENT for table `patent_history`
--
ALTER TABLE `patent_history`
