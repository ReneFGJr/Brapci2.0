 ...
 function newxy3(url, xx, yy) {
     NewWindow = window.open(url, 'newwin3', 'scrollbars=yes,resizable=yes,width=' + xx + ',height=' + yy + ',top=10,left=10');
     NewWindow.focus();
     void(0);
 }

 function newwin(url) {
     NewWindow = window.open(url, 'newwin', 'scrollbars=no,resizable=yes,width=690,height=450,top=10,left=10');
     NewWindow.focus();
     void(0);
 }

 function newwin2(url) {
     NewWindow = window.open(url, 'newwin', 'scrollbars=yes,resizable=yes,width=690,height=450,top=10,left=10');
     NewWindow.focus();
     void(0);
 }
